...
import { Briefcase, MapPin, DollarSign, Clock, Sparkles, ShieldCheck, ExternalLink, Bookmark, BookmarkCheck, FileText } from 'lucide-react';
...
const JobDetailModal = ({ isOpen, onClose, job }) => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-lg font-bold text-slate-500">
                  {job.company_logo ? (
                    <img src={job.company_logo} alt={company} className="w-7 h-7 rounded-lg object-contain" />
                  ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 p-8 sm:p-10">
            ...
            <div className="space-y-8">
              <ExplanationPanel jobId={jobId} jobTitle={title} />
              <SkillGap jobId={jobId} jobTitle={title} />
              ...
              <div className="p-1 bg-slate-900 rounded-[2rem] shadow-xl overflow-hidden">
                <div className="p-8 bg-slate-800 rounded-[1.8rem] border border-white/5 text-center">
                  ...
                  <p className="text-slate-400 text-xs font-medium mb-6">Direct application ensures your profile is prioritized by our system.</p>
                  <div className="flex flex-col gap-3">
                    ...
                    <Button 
                      variant="ghost"
                      className="w-full h-12 rounded-xl font-black text-white hover:bg-white/10 border border-white/10"
                    ...
                    <Button 
                      variant="ghost"
                      className={`w-full h-12 rounded-xl font-black border transition-all ${
                        saved 
      ...
      {/* Cover Letter Modal — stacks on top */}
      <CoverLetterModal
