  ...
  return (
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <div className="relative group">
        ...
        <input
          className={`
            w-full bg-slate-50 border border-slate-100 rounded-xl py-3 px-4
            ${Icon ? 'pl-11' : ''}
            text-sm font-bold text-slate-900 placeholder:text-slate-300
            focus:bg-white focus:ring-4 focus:ring-accent-500/10 focus:border-accent-500
