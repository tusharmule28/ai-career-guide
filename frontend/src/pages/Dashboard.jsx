...
const Dashboard = () => {
  ...
  return (
    <div className="section-container animate-fade-in">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-3xl bg-primary-950 px-8 py-12 md:px-14 md:py-20 mb-12 shadow-2xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-16">
        {stats.map((stat, i) => (
          <Card key={i} className="p-6 md:p-8 flex items-center gap-6 border border-slate-200/50 bg-white/70 shadow-soft">
