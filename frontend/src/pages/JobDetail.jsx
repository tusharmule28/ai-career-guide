  ...
  return (
    <div className="section-container pb-20 animate-fade-in">
      ...
      <div className="mb-8">
        <button 
          onClick={() => navigate(-1)} 
          className="flex items-center gap-2 text-slate-500 hover:text-slate-900 font-bold transition-smooth"
        >
          <ArrowLeft size={20} />
          Back to Results
        </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          {/* Header Card */}
          <div className="p-8 sm:p-12 bg-white rounded-[2.5rem] border border-slate-100 shadow-premium">
             <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
                ...
                <div className="flex flex-col items-center gap-4 bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 min-w-[160px]">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-12">
                <div className="flex items-center gap-3 p-5 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <div className="w-12 h-12 rounded-xl bg-accent-50 text-accent-600 flex items-center justify-center font-bold">
                    <MapPin size={24} />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3 p-5 bg-slate-50/50 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-base font-bold text-slate-900">{salary}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-5 bg-slate-50/50 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-base font-bold text-slate-900">{job.work_type || 'Full-time'}</p>
                  </div>
                </div>
             </div>
          </div>
          ...
          {/* Description Section */}
          <div className="p-8 sm:p-12 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm">
          ...
          <div className="pt-12">
             <div className="flex items-center justify-between mb-8">
                <h3 className="text-2xl font-black text-slate-900">Similar Roles You May Like</h3>
                <Link to="/jobs" className="text-accent-600 font-bold flex items-center gap-1 hover:gap-2 transition-all">
