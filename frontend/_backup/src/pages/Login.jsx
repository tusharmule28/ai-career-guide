    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-6 bg-background">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-text tracking-tight">Access Guide</h1>
          <p className="text-text-secondary mt-4 text-base font-medium">Continue your professional journey with AI.</p>
        </div>
        ...
        <Card className="p-10 md:p-12 shadow-premium">
          ...
          <div className="mt-10 text-center text-sm font-medium">
            <span className="text-text-muted">New explorer? </span>
            <Link to="/signup" className="text-primary-400 font-black hover:text-primary-300 transition-all ml-1 underline decoration-primary-400/30 underline-offset-4">
              Create Account
            </Link>
          </div>
        </Card>
