...
const AppContent = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="py-16 bg-surface/50 border-t border-border/50 mt-auto">
        <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center justify-center gap-6">
                <div className="flex items-center gap-2 group cursor-default">
                    ...
                    <span className="text-xl font-black text-text tracking-tighter">CareerGuide<span className="text-primary-400">AI</span></span>
                </div>
                <div className="text-center text-[10px] font-black uppercase tracking-[0.3em] text-text-muted">
